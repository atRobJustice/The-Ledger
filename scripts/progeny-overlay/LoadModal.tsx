...
import { toProgenyCharacter } from "../utils/characterFormat.js"
...
export const loadCharacterFromJson = async (json: string): Promise<Character> => {
    ...
    const normalized = toProgenyCharacter(parsed) as Record<string, unknown>

    applyCharacterCompatibilityPatches(normalized)
    const loadedCharacter = characterSchema.parse(normalized)
