export const anarch = {
  ...
  structure: {
    ...
    emissaries: {
      description: "Emissaries are diplomats who may work between gangs, cells, councils, Barons, or from Anarch domains to Camarilla domains. As a domain can have any number of factions within and outside; some domain necessitate a large amount of emissaries to push a groups agenda or deliver messages."
    },
    sweeper: {
      description: "Sweeper is a controversial role that some domains may have that may not even be official. This role is for powerful Anarchs who have the power and gumption to remove problem Kindred from the domain. Traitorous gangs, Kindred on an Embracing spree, a Camarilla spy, etc. They deal with it one way or another. They work like the fixer of the domain who other Anarchs can appeal to for such problems. Those that take the role may find it socially isolating."
    },
    gangs: {
      description: "Gangs are similar to a coterie, a group of Anarchs who carve out territory or turf and they overlook it. Oftentimes may get into conflicts with others when they claim too much or clash with other gangs."
    },
    cells: {
  ...
  prominentKindred: [
    {
      name: "Agata Starek",
      description: "A Brujah Anarch of infamy. Polish-born Kindred has taken on many monikers, all inspired for her appetite for Camarilla Princes. A serial diablerist and Bahari sympthaizer, she engages in more brutal methods against the Tower."
    },
    "Theo Bell",
    "Salvador Garcia",
    "Rudi",
