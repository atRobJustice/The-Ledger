export const anarch = {
  ...
  structure: {
    ...
    gangs: {
      description: "Gangs are similar to a coterie, a group of Anarchs who carve out territory or turf and overlook it. Oftentimes they may get into conflicts with others when they claim too much or clash with other gangs. This is considered by some the basic unit of organization in the Movement, with 3-10 Kindred members being the norm. Gangs can get up to large groups as big as 20-30 members, their mortals included. Mortals are often not told of the vampiric side of their group, except for ghouls. Ghouls often operate as henchmen and messengers for the Kindred members of a gang."
    },
    cells: {
