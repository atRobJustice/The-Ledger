export const camarilla = {
  ...
  ashirra: {
    ...
    source: ["Vampire: The Masquerade Corebook", "Vampire: The Masquerade Camarilla", "Vampire: The Masquerade In Memoriam"],
    sourcePage: [51, 23, 89]
  },
  culture: {
    ...
    elysium: "Elysium is a designated location where Kindred can gather without fear of harm. When it is needed they gather in secret sanctuaries known as Elysium, places which often change location to remain secret from mortals. In here there are feasts and ceremonies, negotiations, or heated debates all of which are protected and directed by the Keeper and their heralds. The Keeper of Elysium protects and organizes the Elysia of a city. It can be used for general social gather or court, but may be used for more special occasions including ceremonies, negotiations, or feasts. Physical violence is strictly forbidden, but only makes it a breeding ground for social power plays.",
    bloodHunt: "A Blood Hunt, also known as Lex Talionis or law of retaliation, is considered the ultimate punishment for a Kindred in Camarilla society. While destruction is usually prohibited, those who have a Blood Hunt called on them are free to be hunted, killed, and even become a victim of Diablerie. In the Camarilla, the Prince has the sole power to call a Blood Hunt as given by the Sixth Tradition.",
  ...
  redList: {
    ...
    history: "Camarilla domains started the practice with Lucinde's actions as 'the first Alastor' when she hunted down infamous Kindred, as well as repeat enmity from Ministry methuselah, Kemintiri, in European Camarilla domains.",
  ...
  traditions: {
    ...
    fourth: {
      name: "The Accounting",
      text: "Those thou create are thine own children. Until thy Progeny shall be Released, thou shall command them in all things. Their sins are thine to endure.",
  ...
  history: {
    ...
    warOfAges: {
      ...
      diplomaticRelations: "The Camarilla did have good relations with one sect, the Ashirra; the two started diplomatic talks. With a perfect storm of major events: Second Inquisition, destruction of Vienna Chantry, Clan Tremere Pyramid breaking, Brujah going Anarch, Ur Shulgi's Rise, and Gehenna War in the Middle East. The Camarilla and Ashirra made diplomatic overtures to each other culminating in the Odense Pact and Vermillion Wedding. This Blood Marriage is a Blood Bond between Victoria Ash of Clan Toreador and Tegyrius of the Banu Haqim. The former led to the official entry of the Banu Haqim to the Camarilla.",
