export const banuHaqim = {
  ...
  disciplines: {
    bloodSorcery: "Is used to poison their blades and use their blood as a weapon against others, as well as sift out the truth in blood. They keep their secrets of Blood Sorcery close.",
  ...
  notableCharacters: {
    ...
    alAshrad: {
      description: "The Amr, the most learned and respected of the clan's sorcerers, of the Banu Haqim. Al-Ashrad helped lead many of his clan into the Camarilla after the awakening of Ur-Shulgi as part of the schism in the clan."
    },
    samira: {
      description: "Featured in Vampire: The Masquerade Shadows of New York, she is the Banu Haqim Primogen of New York.",
      currentStatus: "She is the Banu Haqim Primogen of New York."
    },
    justice: {
      description: "Featured in Vampire: The Masquerade Justice, he is the main character that investigates the assassination of his sire in a city controlled by the Hecata.",
  ...
  culture: {
    ...
    kindredSociety: {
      description: "The clan is currently recovering from a large schism in their ranks. This crisis has put the Ashirra and the clan in a rough spot politically, making the Camarilla look more appealing. A union with the Camarilla was more desirable than ever. The Gangrel and Brujah departure made a niche for protectors and hunters the clan was fit for. Though there was always the mutual enmity with the Tremere, two other events helped secure their place: Vienna’s attack and Sabbat Gehenna War. The Ventrue and Tremere may still eye them warily. However, many Kindred of Clan Toreador welcome the newcomers as they are now linked via the Vermillion Wedding, the diplomatic Blood Wedding of Victoria Ash and Tegyrius. In the past the clan had many mercenaries, hired killers, and bounty hunters. For a fee of vitae, an enemy Kindred would meet final death. Now their role has changed, with the Followers of Ur-Shulgi inspiring many to break the ways of old. Their dominance of the law and law breakers has made them ideal members as a pillar of the Camarilla. The Banu Haqim are known as the Judges, their blood calls forth passion for some form of justice. Many believe in a strict code: the tenants of a cult, personal code of honor, rules of a nation, rules of a religion, or any sort of rules the Haqimite lives by. Of course cynical Kindred points out this is just the clan hiding their thirst for diablerie behind determining what’s right and wrong. For if someone is guilty, then they deserve to be drained. Clan culture usually emphasizes childe-sire relationships for mentorship in their blood sorcery ways, though the diaspora of the clan in recent nights has made this challenging. This type of clan culture rewards achievement and rewards the goal-oriented Haqimites. Stark contrast to some clans that exalt lineage or tradition, the Banu Haqim focus more on deed. This pushes many Banu Haqim to be pragmatic and know when to make allies to fit their personal agenda. Coteries with all Banu Haqim usually have a clear focus and purpose, with the Judge keeping the goal in mind. In mixed coteries, Banu Haqim may find themselves drawn to setting the plan and focus of the coterie and pushing their coterie mates forward. They usually gravitate toward roles where they can determine group direction or interpret collective goals. They attempt to be leaders though other clans may chafe under such directions. The latter point is true of younger Kindred who are not looking for such a task-oriented coterie. At times the Haqimite may only be in the coterie until the task is complete. Their pursuit of their agenda’s goals may lead some Banu Haqim to join a different coterie when their old objective is complete. Though they keep former coterie mates as valuable allies and associates. Many Haqimites are always on the move from one coterie to another chasing their goals. Some on the redwork scene see the Banu Haqim in three archetypes: judge, scholar, or bouncer. Judges are Banu with strict personal codes or pretend to have them, scholars are looking to learn history or craft, and the bouncer enjoys applied physical arts of Blood Sorcery.",
