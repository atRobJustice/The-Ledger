export const tremere = {
  ...
  notableCharacters: {
    carna: {
      description: "She was once the Prince of Marseilles and the Primogen of Milwaukee and now has her own splinter cell of Tremere called the House of Carna. Her group advocates for the freedom from the Blood Bond against the Pyramid's tyranny and the misogyny of the clan itself. When the Pyramid planned to eradicate Carna, it was raided by the Second Inquisition at the Great Chantry."
    },
    karlSchrekt: {
      description: "Former Justicar who was a legend within his own clan and the Camarilla. Before his embrace in 1235, he hunted vampires and for centuries after that he acted as the tower's weapon against the Sabbat and Anarchs or other menaces. He hid or destroyed information regarding the Antediluvians. For as many Disciplines as he gained and as few enemies that survived, he's now one of the eldest Tremere remaining."
    },
    aislingSturbridge: "The New York-based High Regent of the Chantry of the Five Boroughs. She oversee research, operations, tutelage, and safety of the chantries. She appears in Coteries of New York, Shadows of New York, and New York by Night.",
    meerlinda: {
      description: "One of the founders of the clan, she has been missing since the attack on the Vienna Chantry by the Second Inquisition. However, the Praesidium believes that she is still alive, and either in torpor or captured somewhere in Krakow, Rome or Moscow."
    },
    dajanSiaka: {
      description: "Dajan Siaka"
    },
    denebOsborne: {
      description: "Deneb Osborne"
    },
    ameliaThorn: {
      description: "Amelia Thorn"
    },
    safiaUlusoy: {
      description: "Safia Ulusoy"
    }
  },
  exclusiveLoresheets: [
