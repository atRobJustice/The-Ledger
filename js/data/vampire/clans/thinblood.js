export const thinblood = {
  ...
  bane: {
    description: "bloods do not suffer from a Bane unless the thin-blood Flaw Clan Curse is taken."
  },
  compulsion: {
    description: "bloods do not suffer from a clan Compulsion."
  },
  general: {
  ...
  archetypes: {
    ...
    bloodChemist: "In their previous life they made designer drugs, sought chemical romance, or psychedelic highs. After the Embrace they've shifted their interest into Thin-blood Alchemy, but one food remains in the drug scene to keep the money flowing.",
  ...
  notableCharacters: {
    kirinTaunk: {
      description: "One of the celebrated alchemists from the 1990s, she pioneered formulae techniques that are still used today. Her work has served as a source of stability for the growing Duskborn community, and it remains untouched by the alchemists purges in other domains and the horrors of the North American Sect Wars. Her guile made her a role model and a folk legend for those who hid from their local scourge. Furthermore, her brewing speed was legendary, and she was a social force of nature, capable of fitting in within the Camarilla and Anarch. Taunk also had a mysterious benefactor. Final Death took her in 1998, but her legacy continues through alchemist groups founded by her apprentices. Created the ''It's All in the Fire Now'' book."
    },
    jordanDeBur: {
      description: "A talented second-year chemistry student before his Embrace. He began experimenting with thin-blood Alchemy, creating elegant and extremely potent alchemy that couldn't be replicated courtesy of obscure plant and animal materials he sourced. His notes were kept on an external hard drive, which he carried everywhere until one day he and his hard drive disappeared in 2012. Fellow Duskborn debate if he was destroyed or went into hiding to avoid the Camarilla branding."
    },
    miriamBlau: {
      description: "A hierophant of alchemy in the 2000s. She was a mathematician, and with her interest in both gematria (Hebrew numerology) and Jewish mysticism, she entered areas of alchemy most have never considered before. She published work on pirate websites, but she offered no formulae, only the mathematical values for ingredients. Some alchemists claim to have startling results with her work, and others could never understand it. She disappeared in her study in Thessaloniki in 2008."
    },
    ferhat: {
      description: "A 16th Generation, he was born as the grandson of Turkish immigrants. He's been a Duskborn for about a week and doesn't know how to survive."
    },
    najmaElmi: {
      description: "A 15h Generation Duskborn, she remembers little of her former life. She reports to Gabriella, one of the Clan Nosferatu's spies, via drop-off points in Southhall Station. She's also in contact with agents of Richard De Worde. It is rumored she is one of the few who can Embrace, though she denies all claims and has never acknowledged a childe."
    },
    dahliaGaudin: {
      description: "Skilled seemstress, Duskborn from a Toreador sire, mistress of Prince (Roi) Villon de Paris."
    },
    alexSimard: {
      description: "A pawn shop owner, smuggler, and merchant. Alex can get his hands on various items for the Kindred of Montreal."
    },
    hugoAndVioletMeyer: {
      description: "Hugo and Violet Meyer"
    },
    babs: {
      description: "Babs"
    },
    claudiAymerich: {
      description: "Claudi Aymerich"
    },
    amberFreeman: {
      description: "Amber Freeman"
    },
    jurgenSchweiger: {
      description: "Jürgen Schweiger"
    },
    noraMccreery: {
      description: "Nora McCreery"
    },
    vitasVarnas: {
      description: "Vitas Varnas"
    },
    landonDankworthFatherChristianPatriot: {
      description: "Landon Dankworth \"Father Christian Patriot\""
    },
    ethanHamza: {
      description: "Ethan & Hamza"
    }
  },
  escapeOptions: {
    diablerie: {
