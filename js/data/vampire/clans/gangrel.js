export const gangrel = {
  ...
  notableCharacters: {
    rudi: {
      description: "An Anarch Representative for the oppressed minorities in Kindred society as well as mortal. Residing in Copenhagen, he stands up for Gangrel kicked out, stands up for woman Kindred run by misogynistic elders and encourages progressive norms over tradition.",
    ...
    markDecker: {
      description: "Prince of Milwaukee who runs his domain like a police state. After attacks from Sabbat and werewolves. the Brujah and Gangrel defection from the Tower, and the threat of the Second Inquisition, he has tightly closed off his Domain controlling who comes and goes. The Gangrel maintains draconian rules with a a strict no Anarch policy, his own harshly enforced set of rules, and keeps eyes on all corners of his domain via tech and animal. He considers this all necessary for the war Kindred face."
    },
    reyMalcolm: {
      description: "A temperamental corporate Gangrel who wants to regain what he lost and is constantly at war with his inner beast. Currently trying to claw back to the top in the Bronx. Appears in New York by Night."
    },
    ramona: {
      description: "A loner Gangrel who aids the Vamily in their early exploits. The leader of a pack of ghouled rats, she uses them as her eyes and ears, on occasion messenger. A resident of Griffith College who appears in LA by Night."
    },
    enkidu: {
      description: "Enkidu"
    },
    arenKonway: {
      description: "Aren Konway"
    },
    delsinCoates: {
      description: "Delsin Coates"
    },
    saule: {
      description: "Saule"
    }
  ...
  culture: {
    embrace: {
      description: "The clan of Gangrel often embrace those who are outsiders, independent hunters, and any one with wanderlust literal or figurative. Gangrel sires love to usually embrace with the urge to fight or survive regardless of their environment. Those who go out bravely into the world and don’t care about the odds against them: businessmen, explorers, rogues, gamblers, etc. When it comes to the ideal childe, their beauty and rank typically mean little, most Gangrel sires want to see what their potential childe has achieved.",
      criteria: [
    ...
    mortalSociety: {
      description: "The Gangrel is a perfect manifestation of their culture and beast, stuck between literal beast and Kindred, never trapped in one place or form. Some even take on the aggressive and territorial aspects of animals. How this translates to Gangrel and humans relations is with some Ferals taking humans and considering them their “pack.” The Gangrel will sometimes establish their dominance and cow their pack into line while taking a form of ownership. Many do not feed on their own and look down on those who “weaken their pack,” preferring to use them for services or even companions.",
    ...
    kindredSociety: {
      description: "The Gangrel are marked with a culture of individualism and wander. Some often travel through domains and cities, crossing borders and city lines as they collect different stories, histories, or adventures. Though they are known to meet around campfires with their clanmates to regal in their adventures they are also prone to the need to establish pecking order, the clan has a culture of friendly rivalry where strength is respected.",
    ...
    factionalDifferences: {
      description: "They have less faction differences than other clans. Stereotyped as the loyal dog of the clans, the Gangrel filled the roles of bodyguards, enforcers, and hunters. Many of the clan left the Camarilla when they felt taken advantage of, but not all Gangrel went Anarch. Whether a Camarilla or Anarch, when a Gangrel arrives to a domain many are reluctant to ask them to leave as fighting is usually the only way to get the Gangrel to leave. This has opened a chance for Ferals to work as mercenaries on their travels from domain to domain.",
